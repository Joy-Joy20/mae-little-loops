...
export default function Home() {
  const products = [
    { name: "Charm", price: "₱200.00", img: "/charm.png" },
    { name: "Pastel Bloom Bouquet", price: "₱250.00", img: "/bouquet1.png" },
    { name: "Lavender Bell Flowers", price: "₱300.00", img: "/bouquet2.png" },
    { name: "Mini White Pastel Flower Bouquet", price: "₱150.00", img: "/bouquet3.png" },
  ];
    ...
    <main className="min-h-screen bg-gray-200">
      ...
      <section className="flex justify-center gap-8 flex-wrap py-16">
        {products.map((item, index) => (
          <div
            key={index}
            className="bg-pink-200 rounded-2xl p-6 w-64 text-center shadow-md"
          >
            <Image
              src={item.img}
              alt={item.name}
